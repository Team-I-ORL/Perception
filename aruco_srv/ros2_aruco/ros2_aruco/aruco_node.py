...
class ArucoNode(rclpy.node.Node):
    def __init__(self):
        ...
        self.declare_parameter(
            name="image_topic",
            value="/head_camera/rgb/image_raw",
            descriptor=ParameterDescriptor(
                type=ParameterType.PARAMETER_STRING,
        ...
        self.declare_parameter(
            ...
            value="/head_camera/rgb/camera_info",
            descriptor=ParameterDescriptor(
                type=ParameterType.PARAMETER_STRING,
        ...
        self.declare_parameter(
            name="camera_frame",
            value="head_camera_rgb_optical_frame",
            descriptor=ParameterDescriptor(
                type=ParameterType.PARAMETER_STRING,
    ...
    def info_callback(self, info_msg):
        ...
        self.get_logger().info(f"Camera Params Recieved!")
    ...
    def image_callback(self, img_msg):
        ...
        self.get_logger().info("Unpacking Msg")
        ...
        self.get_logger().info("Dtecting Markers")
